package com.creusent.user.taxi.views.facebookAccountKit
...
import com.creusent.user.common.utils.Enums.REQ_OTP_VERIFIACTION
...
/*    @BindView(R.id.tv_back_phone_arrow) lateinit var tvPhoneBack: TextView
    ...
    private inner class OtpTextWatcher : TextWatcher {
        ...
        override fun beforeTextChanged(charSequence: CharSequence, i: Int, i1: Int, i2: Int) {
            DebuggableLogI("Creuse", "Textchange")
        }
    ...
    override fun onFailure(jsonResp: JsonResponse, data: String) {
        if (jsonResp != null) {
            Log.e("onFailure jsonResp", jsonResp.toString())
        } else {
            Log.e("onFailure jsonResp", "is null")
        }
        if (data != null) {
            Log.e("onFailure data", data)
        } else {
            Log.e("onFailure data", "is null")
        }
        commonMethods.hideProgressDialog()
