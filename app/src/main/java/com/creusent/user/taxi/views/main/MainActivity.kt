package com.creusent.user.taxi.views.main
...
import com.creusent.user.common.custompalette.CustomTypefaceSpan
import com.creusent.user.common.database.SqLiteDb
import com.creusent.user.common.datamodels.JsonResponse
import com.creusent.user.common.drawpolyline.DirectionsJSONParser
import com.creusent.user.common.helper.Constants
import com.creusent.user.common.helper.Constants.Req_TYPE_NORMAL
import com.creusent.user.common.helper.Constants.Req_TYPE_POOL
import com.creusent.user.common.helper.Constants.scheduledDuration
import com.creusent.user.common.helper.LatLngInterpolator
import com.creusent.user.common.helper.Permission
import com.creusent.user.common.interfaces.ApiService
import com.creusent.user.common.interfaces.ServiceListener
import com.creusent.user.common.map.AppUtils
import com.creusent.user.common.network.AppController
import com.creusent.user.common.placesearch.InfoWindowData
...
import com.creusent.user.common.utils.CommonMethods.Companion.DebuggableLogD
import com.creusent.user.common.utils.CommonMethods.Companion.DebuggableLogE
import com.creusent.user.common.utils.CommonMethods.Companion.DebuggableLogI
import com.creusent.user.common.utils.CommonMethods.Companion.DebuggableLogV
import com.creusent.user.common.utils.CommonMethods.Companion.startChatActivityFrom
import com.creusent.user.common.utils.CommonMethods.Companion.startSinchService
import com.creusent.user.common.utils.Enums.REG_GET_PAYMENTMETHOD
import com.creusent.user.common.utils.Enums.REQ_COMMON_DATA
import com.creusent.user.common.utils.Enums.REQ_GET_DRIVER
import com.creusent.user.common.utils.Enums.REQ_GET_RIDER_PROFILE
import com.creusent.user.common.utils.Enums.REQ_NEAREST_CARS
import com.creusent.user.common.utils.Enums.REQ_SEARCH_CARS
import com.creusent.user.common.utils.Enums.REQ_SEND_REQUEST
import com.creusent.user.common.utils.Enums.REQ_TRIP_DETAIL
import com.creusent.user.common.utils.Enums.REQ_UPDATE_LOCATION
import com.creusent.user.common.utils.RequestCallback
import com.creusent.user.common.utils.RuntimePermissionDialogFragment
import com.creusent.user.common.views.CommonActivity
import com.creusent.user.common.views.SupportActivityCommon
import com.creusent.user.taxi.ScheduleRideDetailActivity
import com.creusent.user.taxi.adapters.CarDetailsListAdapter
import com.creusent.user.taxi.adapters.SeatsListAdapter
import com.creusent.user.taxi.database.AddFirebaseDatabase
import com.creusent.user.taxi.datamodels.DriverLocation
import com.creusent.user.taxi.datamodels.PaymentMethodsModel
import com.creusent.user.taxi.datamodels.RiderProfile
import com.creusent.user.taxi.datamodels.StepsClass
import com.creusent.user.taxi.datamodels.main.NearByCarsModel
import com.creusent.user.taxi.datamodels.main.NearestCar
import com.creusent.user.taxi.datamodels.trip.Riders
import com.creusent.user.taxi.datamodels.trip.TripDetailsModel
import com.creusent.user.taxi.firebase_keys.FirebaseDbKeys
import com.creusent.user.taxi.firebase_keys.FirebaseDbKeys.LIVE_TRACKING_NODE
import com.creusent.user.taxi.firebase_keys.FirebaseDbKeys.TRIP_PAYMENT_NODE
...
import com.creusent.user.taxi.sidebar.payment.AddWalletActivity
import com.creusent.user.taxi.sidebar.payment.PaymentPage
import com.creusent.user.taxi.sidebar.referral.ShowReferralOptions
import com.creusent.user.taxi.sidebar.trips.YourTrips
import com.creusent.user.taxi.singledateandtimepicker.SingleDateAndTimePicker
...
import com.creusent.user.taxi.views.main.filter.FeatureSelectListener
import com.creusent.user.taxi.views.main.filter.FeaturesInCarModel
...
import com.creusent.user.common.network.PermissionCamer
...
//        navigationView.menu.findItem(R.id.nav_support).isVisible = checkVersionModel.support.isNotEmpty()
    ...
    override fun onMapReady(googleMap: GoogleMap) {
        ...
        try {
            ...
            DebuggableLogE("Creuse", "Can't find style. Error: ", e)
        }
