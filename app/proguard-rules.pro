...
-keep public class com.creusent.user.common.helper.** {
     public protected *;
}

-keep class com.creusent.user.taxi.views.firebaseChat.FirebaseChatModelClass{ *; }

-keep class com.creusent.user.taxi.views.main.MainActivity{ *; }
-keep class com.creusent.user.common.datamodels.**{ *; }
-keep class com.creusent.user.taxi.datamodels.**{ *; }
-keep class com.creusent.user.common.map.**{ *; }

-keep class com.creusent.user.taxi.views.voip.CabmeSinchService{ *; }
#}
